...
<div class="SurveyOptions">
    ...
    <div id="Selection" float="center" align="center" >
        ...
        <form action="sendCreatedSurvey.php" method="get">
            <!--Get survey Name-->
            ...
            <?php
            if(isset($_POST['next'])) {
                $query1 = "INSERT INTO survey(survey_name, survey_ID, accountID)
                VALUES('".$survey_name."', '".$survey_ID."', '".$account_ID."')";
                $dbh->exec(query1);

                //I was going to repeat the statment below for each category
                if(isset($_POST['category_div_1']))
                $query2 = "INSERT INTO category(cat_ID, category_name, survey_ID)
                VALUES('".$category_ID."', '".$categories1."', '".$survey_ID."')";
                $dbh->exec(query2);
